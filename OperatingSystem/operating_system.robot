...
*** Keywords ***
Criando um arquivo texto
    Create File         ./my_files/arquivo_TEXTO.txt     Em Robot Framework ja estou um super ninja!!!!

Criando um arquivo JSON
    Create File         ./my_files/arquivo_JSON.json     {"teste05": "valor05", "teste07": 8, "teste03": [3, 1, 2]}
